...
# cifar
python train.py --dataset cifar10 --method margin 	--n_iter 100000 		--save_every 5000 	--valid_images 10000 --seed 1 --m 0.15 --s 10
...
# mnist
python train.py --dataset mnist --method margin 	--n_iter 100000 		--save_every 5000 	--valid_images 10000 --seed 1 --m 0.15 --s 10
...
# stl10
python train.py --dataset stl10 --method margin 	--n_iter 100000 		--save_every 5000 	--valid_images 10000 --seed 1 --m 0.15 --s 10
...
# cat
python train.py --dataset cat --method margin 	--n_iter 100000 		--save_every 5000 	--valid_images 10000 --seed 1 --m 0.15 --s 10
